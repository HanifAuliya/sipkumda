...
class NotificationDropdown extends Component
{
    ...
    public function markAsRead($notificationId)
    {
        ...
        if ($notification) {
            ...
            $typeToEventMap = [
                'admin_persetujuan' => 'openModalDetailRancangan',
