<div>
    ...
    <div class="card shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="mb-0 text-danger">Berkas Ditolak -
                <small class="text-default">Daftar Rancangan dengan status berkas ditolak oleh verifikator ! </small>
            </h3>
        </div>
        <div class="card-body">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu shadow-lg">
                                        ...
                                        <a class="dropdown-item d-flex align-items-center"
                                            onclick="confirmSetujui({{ $item->id_rancangan }})">
                                            <i class="bi bi-clipboard2-check text-success"></i>Setujui Rancangan Kembali
                                        </a>
            ...
            <div wire:ignore.self class="modal fade" id="modalDetailPersetujuan" tabindex="-1" role="dialog"
                aria-hidden="true" data-backdrop="static" data-keyboard="false" data-backdrop="static"
                data-keyboard="false">
                                        ...
                                        <div class="card-body">
                                            <table class="table table-sm table-borderless">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th class="info-text w-25">Tanggal Berkas Disetujui
                                                        </th>
                                                        <td class="wrap-text w-75">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            <p class="mb-3 text-muted">
                                Apakah Anda yakin ingin mereset status rancangan ini ke <strong>"Menunggu
                                    Persetujuan"</strong>?
                            </p>
