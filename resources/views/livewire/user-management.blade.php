    ...
    <div class="col-12">
        ...
        <div class="card  mb-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                @if ($isAdmin)
                    <button class="btn btn-default" wire:click="resetInput" data-toggle="modal" data-target="#addUserModal">
                        Tambah Pengguna
                    </button>
                @endif
            </div>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th wire:click="sortBy('email')" class="sortable cursor-pointer">
                                    Email
                                    @if ($sortField === 'email')
                                        <span>{{ $sortDirection === 'asc' ? '🔼' : '🔽' }}</span>
                                    @endif
                                ...
                                <th wire:click="sortBy('role')" class="sortable cursor-pointer">
                                    Role
                                    @if ($sortField === 'role')
                                        <span>{{ $sortDirection === 'asc' ? '🔼' : '🔽' }}</span>
                                    @endif
                        ...
                        <tbody>
                            @forelse ($users as $index => $user)
                                <tr>
                                    ...
                                    <td>{{ $user->NIP }}</td>
                                    <td>{{ $user->email }}</td>
                                    <td>{{ $user->perangkatDaerah->nama_perangkat_daerah ?? 'N/A' }}</td>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" wire:model="NIP" class="form-control" id="NIP">
                                        @error('NIP')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    {{-- Perangkat Daerah --}}
                                    <div class="col-md-6 mb-3">
                                        <label for="perangkat_daerah_id" class="form-label">Perangkat Daerah</label>
                                        <select wire:model="perangkat_daerah_id" class="form-control"
                                            ...
                                            @foreach ($daftar_perangkat_daerah as $pd)
                                                <option value="{{ $pd->id }}">{{ $pd->nama_perangkat_daerah }}
                                                </option>
                                            @endforeach
                                        </select>
